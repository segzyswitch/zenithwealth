				...
				<div class="col-xl-6 col-md-12">
					<div class="auth-content">
						...
						<div class="title">
							...
							<p>Register to continue with Us To Continue</p>
						</div>
							...
							<form id="registerForm" method="POST" action="#" class="row">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
										<label class="box-label" for="fname">First Name<span class="required-field">*</span></label>
										<input class="box-input" type="text" name="fname" value="" required />
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
										<label class="box-label" for="lname">Last Name<span class="required-field">*</span></label>
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
										<label class="box-label" for="country">Select Country<span class="required-field">*</span></label>
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
										...
										<input class="box-input" type="text" name="referral" value="" />
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
									<div class="single-field">
										...
										<div class="password">
											<input class="box-input" type="password" name="confirm_password" required />
										</div>
									</div>
								</div>
								...
								<div class="col-xl-12">
									<button type="submit" class="site-btn-big primary-btn w-100 submit-btn">
										Create Account
									</button>
								</div>
							</form>
